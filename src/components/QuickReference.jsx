    ...
    return (
      <div className={styles.quickReference}>
        ...
        <table>
          <tbody>
            <tr>
              <td onClick={this.onCodeSnippetClick}>
              ...
              <td onClick={this.onCodeSnippetClick}><pre><code><span className={styles.highlightedCode}>    </span>
                /* This is a code block */</code></pre></td>
              <td><p>Indent four spaces for a preformatted block.</p></td>
            </tr><tr>
              <td onClick={this.onCodeSnippetClick}><pre><code>Let's talk about <span className={styles.highlightedCode}>`</span>
              &lt;html&gt;<span className={styles.highlightedCode}>`</span>!</code></pre></td>
        ...
        <p className={styles.p}>
          <a href="http://daringfireball.net/projects/markdown/syntax"
            target="_blank">Full Markdown documentation</a>
        </p>
      </div>
    );
  }
