  ...
  render() {
    return (
      <div>
        ...
        <p>I made the Minimalist Online Markdown Editor because I love Markdown
          ...
          a <a href="https://chrome.google.com/webstore/detail/minimalist-markdown-edito/pghodfjepegmciihfhdipmimghiakcjf" target="_blank">Chrome app</a>.</p>
        <p>If you have any suggestions or remarks whatsoever, just click on my
          name above and you'll have plenty of ways of contacting me.</p>
        ...
        <ul>
          ...
          <li>The editor automatically saves what you write locally for future use.<br/>
            ...
            the editor or use your browser's privacy mode</li>
        </ul>
      </div>
    );
  }
